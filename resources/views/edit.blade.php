...
@section('title')
  O.S - Editar Solicitação de Diárias {{ $os_diariasid }}
@endsection

{!! Form::model($pessoa, ['route' => ['update', 'cliente' = $pessoa->pesid], 'class' => 'form', 'method' => 'PUT']) !!}
...
@section('content')
  ...
  @section('sec1')
    ...
    <div class="row">
      <div title="Digite seu POSTO/GRAD e NOME COMPLETO" class="col-md-7">
        <div class="input-group">
          ...
          <input type="text" id="pnome" name="pnome" class="form-control input-sm" placeholder="POSTO/GRAD/NOME:" value="{{ $pessoa-> pesncompleto}}">
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div title="Informe o proveito da missão" class="col-md-4">
        <div class="input-group">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div style="border: 1px solid #D3D3D3; border-radius:3px" class="input-group">
          ...
          &nbsp&nbsp<input type="checkbox" id="ck_valor_total" name="valor_total_sem_custo" title="Não havendo custos, favor marcar esta caixa!" value="Sem Custo">&nbsp&nbsp&nbsp&nbspSEM CUSTO
        </div>
      </div>
...
@section('sec2')
  ...
  @section('sec3')
    ...
    <div class="form-group">
      {!! Form::submit('Salvar Ficha', ['class' => 'btn btn-primary'])!!}
    </div>
  @endsection
